...
setwd(dir = "/Users/shermeenvelani/Documents/Projects/Netflix - Experimental Design/data/")
netflix.ph4.5 <- read.csv("2^2+cp_recentre.csv", header = TRUE)
ph4.5 <- data.frame(y = netflix.ph4.5$Browse.Time,
                  x1 = convert.N.to.C(U = netflix.ph4.5$Prev.Length, UH = 90, UL = 60),
                  x2 = convert.N.to.C(U = netflix.ph4.5$Prev.Size, UH = 0.8, UL = 0.6))
...
summary(m)
```
At a 5% significance we can reject the null hypothesis which now means we are in 
